...
//    LazyColumn {
//        items(mainViewModel.exampleSampleList.value) {
//            MovieItem(it)
//        }
//    }
//}
...
//                Text(text = example.title, style = MaterialTheme.typography.titleLarge)
...
//@Preview()//파라미터로 옵션 넣을 수 있음, 프리뷰 쓰는 함수는 파라미터 갖고 있음 안됨
@Composable
fun practiceUi() {
